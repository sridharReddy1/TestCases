cameraParams = cameraParameters('WorldPoints',[1 2],'RotationVectors',[5 6 7],'TranslationVectors',[7 8 9],'TangentialDistortion',[1 2],'ReprojectionErrors',[0.02 0.06],'EstimateSkew',%T,'EstimateTangentialDistortion',%T)
